...
- To grind, hold “on” button while pushing down on the entire top part
  - An orange light under the “on” button indicates the grinder is too hot or not assembled correctly
    ...
    - The machine will begin to overheat after a few samples, give time to cool down.
- Grind each sample for ~2 minutes, until ground to a fine powder

![Picture1](https://github.com/user-attachments/assets/38772925-6477-4e3b-8870-23f6d41ddbf1)

- Unscrew the bottom gray part. Use a brush to scrape any remaining sample around the blade on the upper part into the gray bottom as well.
- Label a new vial with the sample number and tare it on the balance.
- Use a funnel to transfer at least 10.5g of ground sample into the labeled vial

![Picture1](https://github.com/user-attachments/assets/033fd8c4-d60e-4c67-be53-c1b6474ab29a)

- Clean out the grinder for the next sample
...
The sediment mill should not be closed without being properly dry as deterioration of the blade due to water may not only damage the machine but may also contaminate the sediment with rust or other mill debris. 

_General_

Careful measures will be taken to ensure no lab debris contaminates the sediment during the milling process. Further all milled sediment will be carefully brushed out of the mill as sample loss could affect the sample processing.
