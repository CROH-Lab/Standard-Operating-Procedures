# Flow Cytometry to Estimate Symbiont Density
...
[To Start Guava](#Start)

[Running EasyCheck](#EasyCheck)

[Aquiring Samples](#Aqcuiring)

[Shutdown the Guava](#Shutdown)
...
3. Open GuavaSoft app;<img src="https://github.com/user-attachments/assets/d7812ecf-e616-4bb8-ba9c-6a46d614284f" width="600" height="400">
...
1. Go to main menu.
2. Under 'essemtial tools' select 'cleaning'.
3. Click 'start clean' and the tray will eject.
4. Prepare ***NEW*** clean tubes according to the diagram on the laminated cheatsheet.
5. Select ***9*** as the capillary shutdown position. 
