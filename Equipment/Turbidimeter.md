...
|>100 NTU|+/- 5% of stnadard value|

_Only use standards specified for 2100Q Portable Turbidimeter by HACH_
...
Record all information pertaining to the standards, silicon oil, and turbidity free water including the following:
  ...
  - Vendor, catalog number, and strength of turbidity standard (NTU), and chemical grade.
  - Retain all vendor assay specifications. 
Calibration:
  - Retain vendor certificate of factory calibrated instrumentation as well as manufacturer instrument specifications.
  - Record manufacturer make, model, and serial number
  - Record all calibration verification read outs along with the specific standards used to calibrate or verify the instrument (Type of standard and value of standard)
  - Record the name of the calibration analyst
  - Document the success/failure of the initial calibration and all verifications
...
3. Fill auto-pipette to ¾ of the main bulb and then pour into beaker used to discard.
4. Use a small amount of sample to double-rinse the turbidimeter sample vial. Discard the rinse. 
5. Use the auto-pipette to draw out the first sample into one of the small glass bottles used for the turbidity measurements. The glass bottles should be filled to the top of the white line.
6. Repeat steps 2 & 5 two more times with the same sample bottle. By the end of this step there should be 3 of the small glass containers ready for the turbidimeter.
7. Repeat steps 2-6 for your second sample bottle. Making sure to cleanse the autopipette with the new sample before use (step 3).
8. When all 6 glass bottles are ready take them over to the turbidimeter.
9. Calibrate turbidity with the 10 NTU making sure to place a small amount of oil on the glass bottle and using the specific black cloth to wipe it clean. You will only have to calibrate once before you begin processing samples. 
10.	Invert each small sample bottle 3 times to mix the suspended sediment and tap the vial gently to remove any bubbles before placing in the turbidimeter. Also use the black cloth and silicone oil to clean each bottle. May also need a kim wipe prior to get any condensation off of the glass containers.  
11.	Repeat step 10 for each of the 6 glass containers.
12.	When finished with turbidity measurements, rinse out each small glass container gently with DI water and wipe dry before adding new samples.
13.	Repeat steps 2-12 for the rest of your remaining samples. 
...
Turbidimeter calibrations will be performed prior to each use in accordance with FT1000, FT1600, and the Hach manufacturer specified calibration protocol. Only reagents and standards specified by the manufacturer for the Turbidimeter will be used. Further, all turbidimeter tubes will be of the same batch to prevent discrepancies in NTU.
 
_Instrument documentation_

All equipment documentation will be in accordance with those specified in FT1000 and FT1600. All initial calibrations and calibration verifications including the standards used, the readouts, and the success will be recorded in a document and maintained in the laboratory records. Proper documentation of field measurements will also be recorded and maintained. Any errors or complications as well as subsequent corrections to the equipment will be recorded and maintained in the laboratory files. 

### Appendix:
**Calibration Failure:**
If a calibration verification fails to be within the specified standard ranges, perform one or more of the following:
1. Reattempt the continued calibration verification within the chronological bracket time interval without changing the instrument calibration. Do not perform maintenance, repair, or cleaning of the turbidimeter. Clean the turbidity vial and reattempt verification.
2. Perform initial calibration, verify the calibration, reanalyze the samples, and perform a continued calibration verification.
3. Report the results (success/failure) between the last valid calibration and the failed calibration.

_Preventative Maintenance_

Record all maintenance and repair notes in logbook (dates, repair, technicians, certifications, etc.). 
...
[HACH 2100Q Portable Turbidimeter](Equipment/Manuals/HACH2100Q.pdf)
