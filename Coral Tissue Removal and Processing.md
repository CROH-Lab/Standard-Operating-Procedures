...
- Phosphate Buffer Solution (PBS) solution
  - PBS tablets to make more PBS solution
- Two labeled 250mL tri-corner beakers:
  - one to rinse ethanol into (ethanol waste)
  - one to rinse RO water and biological waste into (sink waste)
- Airbrushing containers with 1. PBS water 2. 70% ethanol
- 50mL Falcon tubes for each sample
- 1.5uL Eppendorf tubes for aliquots
- 1 sliding Ziploc bag for each coral sample
- 1000uL pipette tips
...
![Picture1](https://github.com/user-attachments/assets/7b821cfa-2227-4e86-a0f2-7bdc85b26867)

- Turn airbrush motor on (button on top of motor).
- Pull out knob on airbrush motor to adjust pressure. To the left removes pressure, to the right increases pressure. Twist all the way to the right until it doesn’t go anymore (maintain pressure between 3 and 4). Push down on airbrush button to increase pressure.

<img width="79" alt="Picture2" src="https://github.com/user-attachments/assets/c88e5e63-39a0-48f2-9cc1-21969b2d049c" />

*To use the airbrush, if you press the airbrush button down, it’s air, if you press and hold back, it's water.*
- Clean airbrush into a beaker, first with ethanol attachment.
- Then attach PBS bottle and clean airbrush again into another beaker.

![Picture13](https://github.com/user-attachments/assets/2de04560-d58d-4302-990c-f91aa4c89d87)

*Notes: Always keep airbrush upright, place in a larger beaker or on falcon tube stand*
...
![Picture1](https://github.com/user-attachments/assets/6a50cd43-861b-4b64-a7a1-61c6a26edbdb)

- Be conscious of PBS water use (make sure final volume in the falcon tube is the same for every sample), so switch back and forth to just air to spray off excess water.
- The entire coral should turn white. Be consistent with how much you spray for each sample.
- Once done spraying, close bag as much as you can then pour water sample out from the corner of the bag into the 50mL Falcon tube.
- Place Falcon tube back on ice. Sample should ALWAYS be on ice.
- Rinse Ziploc bag one last time with PBS into a tri-corner beaker for water/biological material waste.
...
- If the airbrush is spraying liquid when it should be spraying air (i.e., when you press directly down it should be air and when you press down and pull back it should be liquid from the attached bottle (PBS or ethanol)) then:
  ...
  - Slightly adjust the needle (push slightly forward if it is spraying only liquid OR pull slightly back if it is only spraying air) **(labeled 3)**.
  - **PRO TIP:** When adjusting the needle, you should be able to look through the front piece **(labeled 4)** and push the button down and then use the lever **(labeled 5)** to move the needle back and forth. The needle should have a little bit of space between it and the head of the airbrush when pulled back, allowing water to move through. When just pushed down there should be no space between the needle and head, allowing no water to move through.
...
- Sonicator power unit should be set to an amplitude (AMP) of 20%. The timer should be set according to sample: FDEP 20s
- Fill 2-50mL Falcon tubes, one with 10% bleach and one with RO water. Rinse the probe with RO water between every 5 samples.
  - Rinse with bleach and RO between species.
- Wipe any condensation off of all Falcon tubes before placing 50mL Falcon tube holder in Sonicator housing.
- Raise/lower the probe into the liquid so the majority of probe is in liquid but NOT touching the bottom or sides of the Falcon tube at any time, try to keep prob at/above the 5mL line on 50mL Falcon tube. Hold probe and vertical stand when adjusting. Close and latch the housing door prior to running to avoid hearing damage.

| ![Picture1](https://github.com/user-attachments/assets/d3af02f7-6740-4d48-b75c-11fb5a018bf6) | ![Picture2](https://github.com/user-attachments/assets/91cd751a-384f-4ed1-b753-811934e141a7) |
|:--:|:--:|
...
*Keep pipette up-right hanging, not laying down on lab bench*

*Keep pipette tip box closed to eliminate contamination.*

*Use a new pipette tip between the supernatant and pellet samples.*

- Empty remaining liquid into biological material waste container WITHOUT emptying the algae pellet.
...
*Do not submerge past where the probe and converter are threaded together.*

- Unplug centrifuge and vortex.
...
*Keep bottles with bleach and ethanol under hood. Keep PBS bottles refrigerated.*

*Make sure all surfaces are wiped down and all equipment is unplugged before you leave the lab.*
...
The centrifuge will be properly balanced before each use to prevent damage to the equipment as well as a potential workplace hazard. Properly balanced centrifuge samples will lead to more distinct supernatant and pellets contributing to more precise measures. 
...
8.	Vortex the mixture for 1 minute
