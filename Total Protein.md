...
6. 1M NaOH
7. 0.1M HCl
8. Pipettes P10, P200, P1000 and tips
...
|-----------------------------------------------------------|--------------------------|
|(9 standards + 10 samples) x (2 replicates) x (200 μL of WR)| = 7,600 μL WR + 100 μL for pipette error|
|(9 standards + 20 samples) x (2 replicates) x (200 μL of WR)| = 11,600 μL WR + 100 μL for pipette error|
...
4. Cool plate to 24ºC. Measure the absorbance at or near 562 nm on a plate reader.
